    ...
    protected TileEntityItemHandler(int itemSlots) {
        ...
        this.itemInventory = new ItemStackHandler(this.itemSlotsSize) {
            ...
            protected void onContentsChanged(int itemSlots) {
                TileEntityItemHandler.this.markDirty();
                TileEntityItemHandler.this.onSlotChange(itemSlots);
            }
        };
        ...
        this.itemInventoryIO = new ItemStackHandler(this.itemSlotsSize) {
            ...
            public ItemStack insertItem(int itemSlots, @Nonnull ItemStack stack, boolean simulate) {
                return TileEntityItemHandler.this.insertItem(itemSlots, stack, simulate);
            }

            @Override
            public ItemStack extractItem(int itemSlots, int amount, boolean simulate) {
                return TileEntityItemHandler.this.extractItem(itemSlots, amount, simulate);
            }
        };
    }
