...
public class RegistryRecipes {
	...
	private static void registerRecipe() {
		...
		if (OreDictionary.getOres("plateIron").isEmpty()) { ingotIronOrPlate = "ingotIron"; }
		...
		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), advanced_drain,
				new Object[] { "AAA", "ABA", "AAA", 'A', seared_brick, 'B', smeltery_machine }
		).setRegistryName("advanced_drain"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), fuel_controller,
				new Object[] { "AAA", "ABA", "ACA", 'A', seared_brick_block, 'B', hopper, 'C', furnace }
		).setRegistryName("fuel_controller"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), casting_machine,
				new Object[] { "ADA", "BCB", "ABA", 'A', seared_brick_block, 'B', ice, 'C', casting_table, 'D', smeltery_machine }
		).setRegistryName("casting_machine"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), smeltery_input,
				new Object[] { "ABA", "BCB", "ABA", 'A', seared_brick_block, 'B', hopper, 'C', "chest" }
		).setRegistryName("smeltery_input"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_base, true,
				new Object[] { "ACA", "CBC", "ACA", 'A', "dyeBlue", 'B', ingotIronOrPlate, 'C', "paper" }
		).setRegistryName("upgrade_base"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_slot1, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', "plankWood", 'B', "chest", 'C', upgrade_base }
		).setRegistryName("upgrade_slot1"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_slot2, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', ingotIronOrPlate, 'B', "chest", 'C', upgrade_slot1 }
		).setRegistryName("upgrade_slot2"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_slot3, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', ingotGoldOrPlate, 'B', "chest", 'C', upgrade_slot2 }
		).setRegistryName("upgrade_slot3"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_slot4, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', "gemDiamond", 'B', "chest", 'C', upgrade_slot3 }
		).setRegistryName("upgrade_slot4"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_basin, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', obsidian, 'B', casting_basin, 'C', upgrade_slot4 }
		).setRegistryName("upgrade_basin"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_speed, true,
				new Object[] { "ABA", "BCB", "ABA", 'A', emerald, 'B', sugar, 'C', upgrade_base }
		).setRegistryName("upgrade_speed"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), upgrade_redstone, true,
				new Object[] { "ABA", "CDC", "ABA", 'A', "blockRedstone", 'B', repeater, 'C', "gemQuartz", 'D', upgrade_base }
		).setRegistryName("upgrade_redstone"));

		ForgeRegistries.RECIPES.register(new ShapedOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), iceball, true,
				new Object[] { "AAA", "A A", "AAA", 'A', snowball }
		).setRegistryName("iceball"));

		ForgeRegistries.RECIPES.register(new ShapelessOreRecipe(
				new ResourceLocation(SmelteryIO.MODID), powdered_fuel,
				coalOrDustCoal, "gunpowder", coalOrDustCoal, coalOrDustCoal,
				ingotGoldOrDustGold, coalOrDustCoal, coalOrDustCoal, coalOrDustCoal, coalOrDustCoal
		).setRegistryName("powdered_fuel"));
	}
}
